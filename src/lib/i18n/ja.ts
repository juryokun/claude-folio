const ja = {
  ...
  bulkRenameModal: {
    ...
    start: '開始番号',
    digits: '桁数',
    preserveExt: '元の拡張子を保持',
    pattern: 'パターン',
    patternPlaceholder: '例: IMG_(\\d+)',
    replacement: '置換後',
    globalFlag: 'すべて置換',
    caseInsensitive: '大文字小文字を区別しない',
    targetExt: '拡張子を対象に含める',
    noPreview: 'プレビューする変更はありません',
    cancel: 'キャンセル',
    rename: 'リネーム',
    success: '{{count}}件をリネームしました',
    partialFailure: '{{success}}件成功、{{failed}}件失敗しました',
    errorEmptyName: 'ファイル名が空です: {{name}}',
    errorInvalidName: 'ファイル名に "/" は使用できません: {{name}}',
    errorDuplicateName: '重複するファイル名です: {{name}}',
    errorInvalidRegex: '正規表現が不正です',
  },
  newFileModal: {
    title: '新規ファイル',
    placeholder: 'ファイル名',
