const en = {
  ...
  bulkRenameModal: {
    ...
    start: 'Start number',
    digits: 'Digits',
    preserveExt: 'Keep original extension',
    pattern: 'Pattern',
    patternPlaceholder: 'e.g. IMG_(\\d+)',
    replacement: 'Replacement',
    globalFlag: 'Replace all occurrences',
    caseInsensitive: 'Case-insensitive',
    targetExt: 'Include extension',
    noPreview: 'No changes to preview',
    cancel: 'Cancel',
    rename: 'Rename',
    success: 'Renamed {{count}} items',
    partialFailure: 'Renamed {{success}}, failed {{failed}}',
    errorEmptyName: 'Empty file name: {{name}}',
    errorInvalidName: 'File name cannot contain "/": {{name}}',
    errorDuplicateName: 'Duplicate file name: {{name}}',
